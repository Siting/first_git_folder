...
for i = 1:length(parameterID)
    PARAMETER = struct('parameterID',[],'T',[],'deltaTinSencond',[],'deltaT',[],'nT',[],'numIntervals',[],'numTimeSteps',[],...
        'samplingInterval',[],'numEns',[],'startString',[],'endString',[],'startTime',[],'unixTimeStep',[],'FUNDAMENTAL',[],...
        ...
        'populationSize',[],'samplingSize',[],'criteria',[]);
