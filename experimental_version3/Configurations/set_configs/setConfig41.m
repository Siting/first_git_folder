function[CONFIG]=setConfig41(CONFIG)
...
% parameters
CONFIG.parameterID = 41;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-41';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-41';
