function[SOURCE_LINK, SINK_LINK] = loadBoundaryCondtionABC_network(SOURCE_LINK, SINK_LINK)
...
for i = 1 : length(SOURCE_LINK)
    ...
    load(['.\SensorData\' num2str(boundarySourceSensorIDs(i)) '.mat']);
...
for i = 1 : length(SINK_LINK)
    ...
    load(['.\SensorData\' num2str(boundarySinkSensorIDs(i)) '.mat']);
